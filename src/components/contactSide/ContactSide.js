...
class ContactSide extends React.Component {
  state = {
    ...
    message: "",
    ContactItems: [
      { id: 1, title: "E-mail", body: "aleksander_gjoni@outlook.com" },
      { id: 2, title: "Address", body: "Tirana,Albania" },
    ],
  };
        ...
        <div className="leave-Message">
          ...
          <form onSubmit={this.handleSubmit}>
            <div className="row">
              <div className="col-12 col-sm-6">
                <div className="form-group">
                  <input
                    type="text"
                    className="form-control rounded-0 o-border-purple"
                    name="fullName"
            ...
            <div className="form-group">
              <button
                type="submit"
                className="m-3 text-white o-btn text-center py-2 position-relative"
              >
                Send Message
              </button>
            </div>
